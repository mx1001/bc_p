...
class BoxCutterDrawPoly(bpy.types.Operator):
        """Draw a box from 2d shape """
        bl_idname = "boxcutter.draw_poly"
        bl_label = "Box Cutter Draw Poly"
        ...
        def execute(self, context):
            ...
            if bpy.context.scene.BoxCutter_cut_loop == False :
